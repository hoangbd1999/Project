...
class _AnimationPageState extends State<AnimationPage> {
  ...
  bool isBack = true;
  double angle = 0;
  String line1 = "Tym Tym";
  String line2 = "Chúc chị em 8/3 xinh đẹp như ảnh trên mạng";
    ...
    return GestureDetector(
      ...
      onTap: () {
        setState(() {
          ...
          if (selected) {
            line1 = "Love Love";
            line2 = "Chúc chị em 8/3 vui vẻ và mãi xinh đẹp";
          } else {
            line1 = "Love";
            line2 = "Chúc chị em 8/3 xinh đẹp như ảnh trên mạng";
          }
          angle = (angle + pi) % (2 * pi);
        });
      },
